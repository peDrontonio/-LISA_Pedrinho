...
class Controlador:
    def __init__(self):
        ...
        rospy.wait_for_service('/draw_on_board')  # Espera pelo serviço de desenho
        ...
        self.draw_on_board = rospy.ServiceProxy('/draw_on_board', Trigger)  # Proxy para o serviço de desenho
